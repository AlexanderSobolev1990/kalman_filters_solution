...
public:
    ...
    ///
    CKalmanUKF( const CKalmanUKF &other ) : CKalmanEKF<SizeX, SizeY>( other )
    {
    ...
    /// \return *this
    ///
    CKalmanUKF& operator=( const CKalmanUKF &other )
    {
        CKalmanUKF copy( other );
        swap( *this, copy );
        return *this;
    }
    ...
    /// \param other - экземпляр, с которого делается копия
    ///
    CKalmanUKF( CKalmanUKF &&other ) noexcept
    {
        swap( *this, other );
    }
    ...
    /// \return *this
    ///
    CKalmanUKF& operator=( CKalmanUKF &&other ) noexcept
    {
        swap( *this, other );
        return *this;
    }

    virtual ~CKalmanUKF() = default; ///< Дестркутор
    ...
    ///
    friend void swap( CKalmanUKF<SizeX, SizeY> &lhs, CKalmanUKF<SizeX, SizeY> &rhs ) noexcept
    {
